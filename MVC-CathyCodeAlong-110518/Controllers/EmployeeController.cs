...
using MVC_CathyCodeAlong_110518.DataAccessLayer;
using MVC_CathyCodeAlong_110518.Models;

namespace MVC_CathyCodeAlong_110518.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Salary,Position,Department")] Employee employee)
        {
            ...
            {
                db.Employees.Add(employee); //Add employee to the table of employee
                db.SaveChanges();
